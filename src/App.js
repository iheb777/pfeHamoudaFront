...
import JuryManageProjects from "./pages/Jury/JuryManageProjects";
            ...
            currentUser ?
              (() => {
                switch (currentUser.role) {
                  ...
                  case "ADMIN":   return <Container  >
                    {loading ? <div>Loading...</div> : <>
                      {menuOpen && <AdminMenu setMenuOpen={setMenuOpen} setDarkMode={setDarkMode} darkMode={darkMode} setNewTeam={setNewTeam} />}
                      ...
                      <Main>
                        ...
                        <Wrapper>
                           <Routes>
                            <Route >
                              <Route exact path="/" element={<AdminHome setNewTeam={setNewTeam} setNewProject={setNewProject}/>} />
                              <Route exact path="manage-student" element={<ManageStudent setNewTeam={setNewTeam} setNewProject={setNewProject}/>} />
                              <Route exact path="manage-coach" element={<ManageCoach setNewTeam={setNewTeam} setNewProject={setNewProject}/>} />
                              <Route exact path="manage-jury" element={<ManageJury setNewTeam={setNewTeam} setNewProject={setNewProject}/>} />
                  ...
                  case "JURY":  return <Container  >
                    {loading ? <div>Loading...</div> : <>
                      {menuOpen && <JuryMenu setMenuOpen={setMenuOpen} setDarkMode={setDarkMode} darkMode={darkMode} setNewTeam={setNewTeam} />}
                      <Main>
                        <Navbar menuOpen={menuOpen} setMenuOpen={setMenuOpen} />
                        <Wrapper>
                          {newTeam && <AddNewTeam setNewTeam={setNewTeam} />}
                          ...
                          <Routes>
                            <Route >
                              ...
                              <Route path="projects" element={<JuryManageProjects newProject={newProject} setNewProject={setNewProject}/>} />
                              <Route path="teams">
                                <Route path=":id" element={<Teams />} />
                              </Route>
                              <Route path="chats" element={<Chats />} />
                  ...
                  case "COACH":  return <Container  >
                    {loading ? <div>Loading...</div> : <>
                      {menuOpen && <CoachMenu setMenuOpen={setMenuOpen} setDarkMode={setDarkMode} darkMode={darkMode} setNewTeam={setNewTeam} />}
                      <Main>
                        <Navbar menuOpen={menuOpen} setMenuOpen={setMenuOpen} />
                        <Wrapper>
                          {newTeam && <AddNewTeam setNewTeam={setNewTeam} />}
                          ...
                          <Routes>
                            <Route >
                              ...
                              <Route path="projects">
                                <Route path=":id" element={<CoachProjectDetails />} />
                              </Route>
                              <Route path="projects/invite">
                                <Route path=":code" element={<ProjectInvite />} />
                              </Route>
                  ...
                  default:      return <ThemeProvider theme={darkTheme}>
                    <Routes>
                      <Route exact path="/">
                        <Route index element={
                          <Home />} />
